...
const walletSchema = new mongoose.Schema(
    {
        ...
        transactionType: { type: String, enum: ['membership', 'dailyPayout','teamPerformance','referral_bonus_10_users','royaltyIncome','monthlyReward','wallet_recharge','teamPerformancePayout','referralBonus'], required: true },
